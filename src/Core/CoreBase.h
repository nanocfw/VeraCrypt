...
namespace VeraCrypt
{
	...
	public:
		...
		virtual void ReEncryptVolumeHeaderWithNewSalt (BufferPtr *newHeaderBuffer, shared_ptr <VolumeHeader> header, shared_ptr <VolumePassword> password, int pim, shared_ptr <KeyfileList> keyfiles) const;
